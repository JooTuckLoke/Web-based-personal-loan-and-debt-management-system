<%-- 
    Document   : viewAppt
    Created on : 10 Jun 2022, 3:21:41 pm
    Author     : Acer
--%>
...
<html>
    ...
    <body class="d-flex h-100 text-center text-white bg-dark">
        <%       
            ...
            session.setAttribute("username", "Jackson");
            ...
            String qry = "SELECT * FROM faappointment username='"+(String)session.getAttribute("username")+"'";
            ...
            <main class="px-3">
                <table class="table table-dark table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="editAppt.jsp" class="btn btn-lg btn-secondary fw-bold border-white bg-white">Update</a> <a onclick="myFunction()" class="btn btn-lg btn-secondary fw-bold border-white bg-white">Delete</a></td>
                        </tr>
                    </tbody>
                </table>   
            </main>
